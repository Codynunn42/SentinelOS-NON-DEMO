...
| retry result | requested validation support | recorded in `docs/LIVE_PROOF_HEALTH_RETRY_RESULT_2026-06-30.md` | gate remains `blocked_not_failed` |
...
proof_health_gate:
  ...
  owner_queue_order_approval: docs/JULY_QUEUE_ORDER_AND_FIRST_ACTION_APPROVAL_RESULT_2026-06-30.md
  latest_retry_result: docs/LIVE_PROOF_HEALTH_RETRY_RESULT_2026-06-30.md
  next_action:
