...
request_result:
  ...
  existing_scope_review: docs/OBSERVABILITY_PACKET_COMMIT_SCOPE_REVIEW_2026-05-30.md
  manifest_revision: docs/OBSERVABILITY_PACKET_MANIFEST_REVISION_2026-05-30.md
  split_review: docs/OBSERVABILITY_PACKET_SPLIT_REVIEW_2026-05-30.md
