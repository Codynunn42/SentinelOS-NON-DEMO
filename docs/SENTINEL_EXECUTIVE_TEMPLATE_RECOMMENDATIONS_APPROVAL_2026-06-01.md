...
next_processing_queue:
  1_refresh_current_worktree_and_staging_manifest:
    ...
    status: complete
    artifact: docs/REFRESHED_CURRENT_CONTROL_PACKET_STAGING_MANIFEST_2026-06-01.md
  ...
  6_next_commit_decision:
    ...
    source_manifest: docs/REFRESHED_CURRENT_CONTROL_PACKET_STAGING_MANIFEST_2026-06-01.md
```
