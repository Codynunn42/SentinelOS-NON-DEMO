...
| `docs/TASK_TEMPLATES_SYSTEM.md` | documents `conditional_approval` badge as `[APPROVE:CONDITIONAL]` | documentation mismatch |
...
| `docs/TASK_TEMPLATES_SYSTEM.md` | does not list `billing_checkout` in the categories table | documentation gap |
