...
```yaml
governing_inputs:
  master_operating_binder: docs/NUNN_CORPORATION_MASTER_OPERATING_BINDER_2026-06-15.md
  prior_daily_closeout: docs/SUNDAY_DAILY_EXECUTIVE_CADENCE_CLOSEOUT_2026-06-14.md
  ...
  current_manifest_review: docs/EXACT_RELEASE_STAGING_MANIFEST_REVIEW_RESULT_2026-06-15.md
  current_support_tracker: docs/NUNNCORP_SENTINELOS_ISSUE_SUPPORT_TRACKER_2026-06-14.md
```
