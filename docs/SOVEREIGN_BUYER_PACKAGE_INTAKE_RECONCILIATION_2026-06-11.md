...
- `docs/GOVERNMENT_POSITIONING.md` prohibits premature certification,
...
now prepared in `docs/SOVEREIGN_LIGHT_MODE_APPROVAL_PACKET_2026-06-11.md`.
...
light_mode_candidate:
  packet: docs/SOVEREIGN_LIGHT_MODE_APPROVAL_PACKET_2026-06-11.md
  signature_model_candidate: Ed25519
  security_overview_draft: docs/SOVEREIGN_SECURITY_AND_GOVERNANCE_OVERVIEW_DRAFT_2026-06-11.md
  readiness_scorecard: docs/SOVEREIGN_READINESS_SCORECARD_2026-06-11.md
