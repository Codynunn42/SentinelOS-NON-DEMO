...
| --- | --- |
| `docs/GBP/doctrine/NUNN_CORPORATION_MASTER_OPERATING_BINDER_2026-06-15.md` | constant operating binder |
| `docs/GBP/assessments/CADENCE_INDEX_2026-06-30.md` | cadence evidence map |
| `docs/GBP/assessments/SENTINEL_AI_JUNE_CLOSEOUT_READY_ON_HOLD_WORKFLOW_2026-06-30.md` | unified ready-on-hold workflow |
| `docs/GBP/assessments/EXECUTIVE_BOARD_JULY_STARTING_POINT_2026-06-30.md` | July Board starting point |
| `docs/GBP/assessments/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_JULY_STARTING_POINT_2026-06-30.md` | July executive template starting point |
| `docs/governance/WEEKLY_AND_MONTH_END_CLOSEOUT_2026-06-30.md` | weekly/month-end closeout state |
| `docs/GBP/assessments/JULY_PRIORITY_QUEUE_DEEP_DIVE_DECISION_PACKETS_2026-06-30.md` | packet queue |
| `docs/GBP/doctrine/SP1_LOW_LATENCY_PROOF_PIPELINE_MOCK_OPTIMIZATION_PACKET_2026-06-30.md` | Platform Next SP1 research candidate |
| `docs/governance/LIVE_PROOF_HEALTH_RETRY_RESULT_2026-06-30.md` | latest proof-health retry evidence |
| `docs/governance/H1_OWNERFI_PROOF_HEALTH_VALIDATION_RESULT_2026-06-30.md` | one-by-one H1 proof-health processing result |
| `docs/governance/H1_GOVERNANCE_CLOSEOUT_AND_OWNER_DECISION_2026-06-30.md` | owner decision and governance closeout for H1 |
| `docs/GBP/assessments/JULY_PRIORITY_QUEUE_READINESS_PROCESSING_RESULT_2026-06-30.md` | active July readiness processing result |
| `docs/GBP/overlays/NEXT_STEPS.md` | operational queue index |
...
next_action:
  ...
  latest_processing_result: docs/GBP/assessments/JULY_PRIORITY_QUEUE_READINESS_PROCESSING_RESULT_2026-06-30.md
```
