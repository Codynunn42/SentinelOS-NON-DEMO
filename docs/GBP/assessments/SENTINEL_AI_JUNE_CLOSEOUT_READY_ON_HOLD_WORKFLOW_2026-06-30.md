...
| `docs/governance/WEEKLY_AND_MONTH_END_CLOSEOUT_2026-06-30.md` | weekly and month-end closeout |
| `docs/GBP/assessments/EXECUTIVE_BOARD_JULY_STARTING_POINT_2026-06-30.md` | Board starting point |
| `docs/GBP/assessments/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_JULY_STARTING_POINT_2026-06-30.md` | Executive Template starting point |
| `docs/GBP/assessments/JULY_PRIORITY_QUEUE_READINESS_PACKET_2026-06-30.md` | July readiness matrix |
| `docs/GBP/assessments/JULY_PRIORITY_QUEUE_DEEP_DIVE_DECISION_PACKETS_2026-06-30.md` | deep dive decision packets |
| `docs/governance/LIVE_PROOF_HEALTH_RETRY_RESULT_2026-06-30.md` | latest proof-health gate evidence |
