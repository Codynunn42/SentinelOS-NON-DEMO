...
**Executive Template Compared:** `docs/governance/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_2026-07-03.md`  
...
| Drift | Remediation |
| --- | --- |
| Board Template stale | `docs/GBP/assessments/EXECUTIVE_BOARD_JULY_05_ADDENDUM_2026-07-05.md` |
| Executive Template stale | `docs/GBP/assessments/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_JULY_05_ADDENDUM_2026-07-05.md` |
| MOB completion queue stale | `docs/GBP/assessments/MOB_COMPLETION_QUEUE_REFRESH_OVERLAY_2026-07-05.md` |
| MOB verification matrix stale | `docs/GBP/assessments/MOB_VERIFICATION_MATRIX_ADDENDUM_2026-07-05.md` |
| Worktree/evidence baseline stale | `docs/GBP/assessments/CURRENT_WORKTREE_EVIDENCE_BASELINE_2026-07-05.md` |
