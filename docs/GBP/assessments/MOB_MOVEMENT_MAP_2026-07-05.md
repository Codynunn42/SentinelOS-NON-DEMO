...
**Template:** `docs/GBP/assessments/MOB_NEXT_STEPS_TEMPLATE_2026-07-05.md`
**External Use:** held
...
```yaml
processing_result: docs/GBP/assessments/MOB_MOVEMENT_QUEUE_PROCESSING_RESULT_2026-07-05.md
