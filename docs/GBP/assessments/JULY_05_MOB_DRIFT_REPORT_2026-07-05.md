...
| Source | Role |
| --- | --- |
| `docs/GBP/doctrine/NUNN_CORPORATION_MASTER_OPERATING_BINDER_2026-06-15.md` | Constant MOB source |
| `docs/GBP/assessments/JULY_05_CADENCE_INDEX_2026-07-05.md` | Current cadence index |
| `docs/GBP/assessments/JULY_05_DAILY_AND_WEEKLY_CADENCE_CLOSEOUT_2026-07-05.md` | Sunday cadence closeout |
| `docs/GBP/assessments/JULY_05_EXECUTIVE_MOB_BOARD_COMPARISON_2026-07-05.md` | Executive/MOB/Board comparison |
...
| `docs/governance/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_2026-07-03.md` | Executive template under comparison |
| `docs/GBP/assessments/EXECUTIVE_BOARD_JULY_05_ADDENDUM_2026-07-05.md` | Remediates `MOB-DRIFT-001` |
| `docs/GBP/assessments/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_JULY_05_ADDENDUM_2026-07-05.md` | Remediates `MOB-DRIFT-002` |
| `docs/GBP/assessments/MOB_COMPLETION_QUEUE_REFRESH_OVERLAY_2026-07-05.md` | Remediates `MOB-DRIFT-003` |
| `docs/GBP/assessments/MOB_VERIFICATION_MATRIX_ADDENDUM_2026-07-05.md` | Remediates `MOB-DRIFT-004` |
| `docs/GBP/assessments/CURRENT_WORKTREE_EVIDENCE_BASELINE_2026-07-05.md` | Remediates `MOB-DRIFT-005` |
...
| MOB-DRIFT-002 | Executive Template | Templates should refresh from MOB and carry current next gate | `docs/governance/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_2026-07-03.md` predates Gate 8 completion and Gate 9 out-of-scope confirmation | Executive Template needs addendum | Medium | Add July 5 Executive addendum or update next-gate packet |
...
| --- | --- | --- |
| MOB-DRIFT-001 | `docs/GBP/assessments/EXECUTIVE_BOARD_JULY_05_ADDENDUM_2026-07-05.md` | remediated review-held |
| MOB-DRIFT-002 | `docs/GBP/assessments/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_JULY_05_ADDENDUM_2026-07-05.md` | remediated review-held |
| MOB-DRIFT-003 | `docs/GBP/assessments/MOB_COMPLETION_QUEUE_REFRESH_OVERLAY_2026-07-05.md` | remediated review-held |
| MOB-DRIFT-004 | `docs/GBP/assessments/MOB_VERIFICATION_MATRIX_ADDENDUM_2026-07-05.md` | remediated review-held |
| MOB-DRIFT-005 | `docs/GBP/assessments/CURRENT_WORKTREE_EVIDENCE_BASELINE_2026-07-05.md` | remediated review-held |
