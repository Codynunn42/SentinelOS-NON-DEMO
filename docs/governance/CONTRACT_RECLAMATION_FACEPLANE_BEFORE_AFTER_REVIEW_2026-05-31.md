...
review_inputs:
  ...
  faceplane_docking_doctrine: docs/governance/FACEPLANE_GAAS_DOCKING_DOCTRINE.md
  surface_planes_doc: docs/governance/SURFACE_PLANES.md
  system_positioning: docs/governance/SYSTEM_POSITIONING.md
...
upgrade_verdict:
  ...
  current_recommendation:
    ...
    result: produced
    artifact: docs/governance/CONTRACT_RECLAMATION_FACEPLANE_ALIGNMENT_PLAN_2026-05-31.md
    reason:
