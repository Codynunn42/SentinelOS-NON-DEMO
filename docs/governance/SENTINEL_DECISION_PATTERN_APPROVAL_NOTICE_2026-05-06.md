...
| Item | Approval |
| --- | --- |
| `docs/governance/SENTINELOS_DEMO_PACKAGE_V2.md` | `[APPROVED:DEMO-PACKAGE]` |
| `docs/governance/SENTINELOS_LIVE_DEMO_SCRIPT_V2.md` | `[APPROVED:DEMO-PACKAGE]` |
| `docs/governance/SENTINELOS_PROOF_SHEET_V2.md` | `[APPROVED:DEMO-PACKAGE]` |
| `docs/governance/PROOF_CASE_GOVERNED_DEAL_EXECUTION_V2.md` | `[APPROVED:REFERENCE-IMPLEMENTATION]` |
...
| Item | Approval |
| --- | --- |
| `docs/governance/FACEPLANE_GAAS_DOCKING_DOCTRINE.md` | `[APPROVED:FACEPLANE-DOCTRINE]` |
| `docs/governance/FACEPLANE_SDK_SPEC.md` | `[APPROVED:FACEPLANE-SDK-SPEC]` |
...
| Item | Approval |
| --- | --- |
| `docs/governance/SENTINELOS_SOURCE_DOCUMENT_ALIGNMENT_2026-05-06.md` | `[APPROVED:SOURCE-ALIGNMENT]` |
| `docs/governance/BUILD_MANUAL_REVIEW_2026-05-06.md` | `[APPROVED:BUILD-REVIEW]` |
...
| Item | Approval |
| --- | --- |
| `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | `[APPROVED:VENDOR-ONBOARDING-REFERENCE]` |
...
| Item | Approval |
| --- | --- |
| `docs/governance/TASK_TEMPLATES_SYSTEM.md` | `[APPROVED:TASK-SYSTEM]` |
| `apps/sentinel/src/orchestration/taskTemplates.js` | `[APPROVED:TASK-SYSTEM]` |
| `docs/governance/GOVERNED_TELEMETRY_HARMONIZER.md` | `[APPROVED:GTH]` |
| `apps/sentinel/src/telemetry/*` | `[APPROVED:GTH]` |
| `docs/governance/STRIPE_CHECKOUT_INGESTION_REPORT.md` | `[APPROVED:BILLING-GATE]` |
| `apps/api/public/stripe-*` | `[APPROVED:BILLING-SURFACE]` |
| `apps/sentinel/src/verification/stateAnchors.js` | `[APPROVED:STATE-ANCHORING]` |
| `docs/governance/STATE_ANCHORING_RUNBOOK.md` | `[APPROVED:STATE-ANCHORING]` |
...
| `docs/governance/RELEASE_v1.2.0.md` | `[APPROVED:RELEASE-NOTES]` |
| `docs/governance/RELEASE_v1.3.0.md` | `[APPROVED:RELEASE-NOTES]` |
...
- `repo:scan` produced `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-07.md` and `docs/governance/sentinel-repo-organization-log-2026-05-07.jsonl`.
...
| Item | Status | Reason |
| --- | --- | --- |
| `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | `[HOLD:REVIEW]` | Missing validation-window template, audit export check, and tenant activation approval template. |
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | `[HOLD:REVIEW]` | Public-sector material needs draft/external-use decision. |
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | `[HOLD:REVIEW]` | PDF needs source/status confirmation before circulation. |
| `docs/governance/COMMERCIAL_ASSETS_2026-04-29.pdf` | `[HOLD:REVIEW]` | Generated asset needs confirmed canonical source relationship. |
