...
- `docs/governance/DAILY_BRIEF_RETENTION_RULE.md`
- `docs/governance/TASK_TEMPLATES_SYSTEM.md`
- `docs/governance/GOVERNED_TELEMETRY_HARMONIZER.md`
- `docs/governance/README.md` as the canonical mapping index

## Conditionally Approved To Complete

| Item | Badge | Required For Final Approval |
| --- | --- | --- |
| `docs/governance/COMMERCIAL_ASSETS_2026-04-29.pdf` | `[APPROVE:CONDITIONAL]` | Owner confirms PDF matches `docs/governance/COMMERCIAL_ASSETS_2026-04-29.md`. |
| `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | `[APPROVE:CONDITIONAL]` | Keep aligned with passing vendor onboarding checks. |
...
| --- | --- | --- |
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | `[HOLD:REVIEW]` | Draft metadata, owner, version, audience, and evidence mapping. |
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | `[HOLD:REVIEW]` | Confirm source and label as draft or regenerate after source approval. |
| `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | `[HOLD:REVIEW]` | Enforcement map to routes, checks, scopes, approvals, and audit events. |
| `docs/governance/DAILY_BRIEF_2026-04-23.md` | `[HOLD:REVIEW]` | Protected by daily brief retention rule. |
| `docs/governance/DAILY_BRIEF_2026-04-24.md` | `[HOLD:REVIEW]` | Protected by daily brief retention rule. |
