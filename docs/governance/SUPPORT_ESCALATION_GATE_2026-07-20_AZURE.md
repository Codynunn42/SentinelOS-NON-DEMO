...
complete and Azure Support is the required escalation lane.
...
- Primary lane (`Azure|AWS|Other`): Azure
...
- Provider (`Azure Support|AWS Business Support|Other`): Azure Support
