...
| --- | --- | --- | --- |
| `[APPROVED:EVIDENCE]` | `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-04.md` | Internal scan artifact with no runtime behavior and no external claim surface. | Approve as current evidence. Re-run scanner after approval decisions or major file changes. |
...
| --- | --- | --- | --- | --- | --- |
| `[APPROVE:CONDITIONAL]` | `docs/governance/COMMERCIAL_ASSETS_2026-04-29.pdf` | Medium | Confirm `docs/governance/COMMERCIAL_ASSETS_2026-04-29.md` is the canonical source and PDF was generated from it. | Add a source/deliverable note to the docs index. | Approve as external-ready collateral. |
| `[APPROVE:CONDITIONAL]` | `docs/governance/README.md` | Medium | Convert into canonical docs index by lane. | Add links/status for proof, deployment, governance, commercial, vendor onboarding, and reports. | Approve as canonical navigation surface. |
| `[APPROVE:CONDITIONAL]` | `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | Medium | Keep aligned with `vendor-onboarding-v1.0` and passing rule checks. | Reference passing `npm run check:vendor-onboarding`; add canonical code pointers if missing. | Approve as operator/auditor reference. |
...
| --- | --- | --- | --- | --- |
| `[HOLD:REVIEW]` | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | Public-sector proposal language can be mistaken for an official deliverable. | Add owner, version, date, `Discussion Draft`, evidence status, and external-use boundary. | Prepare a draft header/status block; do not publish. |
| `[HOLD:REVIEW]` | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | PDF can circulate without repo context. | Confirm source Markdown, draft status, version, and approved audience. | Hold until Markdown source is approved; then regenerate or label PDF. |
| `[HOLD:REVIEW]` | `docs/governance/DAILY_BRIEF_2026-04-23.md` | Historical daily record; similarity does not mean duplicate. | Define retention rule: immutable daily snapshot vs summarized status archive. | Leave untouched; propose retention rule. |
| `[HOLD:REVIEW]` | `docs/governance/DAILY_BRIEF_2026-04-24.md` | Historical daily record; should not be merged casually. | Compare with 2026-04-23 and decide whether both remain immutable records. | Leave untouched; propose retention rule. |
| `[HOLD:REVIEW]` | `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | Policy-setting language without enforcement mapping. | Map doctrine to checks, scopes, approval ledger behavior, and tenant activation gates. | Prepare enforcement mapping before approval. |
...
| --- | --- | --- | --- | --- |
| `[REVIEW:SIMILARITY]` | README group | `README.md`, `apps/README.md`, `docs/governance/README.md`, `infrastructure/README.md`, `services/README.md` | Medium | Keep all for now; make `docs/governance/README.md` the docs index and leave area READMEs scoped to their folders. |
...
| `[REVIEW:SIMILARITY]` | Daily brief group | `docs/governance/DAILY_BRIEF_2026-04-23.md`, `docs/governance/DAILY_BRIEF_2026-04-24.md` | Medium | Hold; define daily brief retention rule. |
| `[REVIEW:SIMILARITY]` | GTM/product group | `docs/governance/GO_TO_MARKET.md`, `docs/governance/PRODUCT.md` | Medium | Keep both; later assign GTM vs product source-of-truth boundary. |
| `[REVIEW:SIMILARITY]` | OwnerFi workflow group | `docs/governance/PROOF_CASE_OWNERFI.md`, `docs/governance/WORKFLOW_DEFINITIONS.md` | Medium | Keep both; later mark one as narrative proof case and one as command contract. |

## Targeted Streamlining Work Order

### Step 1 - Approve Evidence

- Approve `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-04.md`.
- Approve `docs/governance/SENTINEL_APPROVAL_RISK_ANALYSIS_2026-05-04.md`.
...
- Update `docs/governance/README.md` into a canonical docs index.
