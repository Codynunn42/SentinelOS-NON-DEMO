...
- Plan reference: `docs/governance/HERGLASS_FACEPLANE_PLAN.md`
...
- Plan reference: `docs/governance/OPENAI_FACEPLANE_PLAN.md`
- Public status: internal only
...
- Control input reference: `docs/governance/DOE_T2_CDT_001_FACEPLANE_CONTROL_INPUT_2026-05-31.md`
...
- Review reference: `docs/governance/CONTRACT_RECLAMATION_FACEPLANE_BEFORE_AFTER_REVIEW_2026-05-31.md`
- Alignment plan reference: `docs/governance/CONTRACT_RECLAMATION_FACEPLANE_ALIGNMENT_PLAN_2026-05-31.md`
