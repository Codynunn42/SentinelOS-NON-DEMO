...
vr_0001_recommendation_queue:
  1:
    ...
    status: completed
    result: docs/governance/MISSION_CONTROL_ROUTE_CLASSIFICATION_PUBLIC_PROTECTED_INTERNAL_HELD_2026-07-06.md
  ...
  2:
    ...
    execution_mode: read_only
    status: completed
    result: docs/governance/API_CONTROL_EXECUTE_HARDENING_DECISION_PACKET_2026-07-06.md
...
vr_job_state:
  ...
  completed_result: docs/governance/MISSION_CONTROL_ROUTE_CLASSIFICATION_PUBLIC_PROTECTED_INTERNAL_HELD_2026-07-06.md
