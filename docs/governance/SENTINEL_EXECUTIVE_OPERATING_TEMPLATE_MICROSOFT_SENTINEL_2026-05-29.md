...
executive_template:
  ...
  observability_packet:
    primary_artifact: docs/governance/MICROSOFT_SENTINEL_OBSERVABILITY_ALIGNMENT_REVIEW_2026-05-29.md
    support_artifacts:
...
face_plane_attachment:
  first_face_plane:
    ...
    plan_document: docs/governance/HERGLASS_FACEPLANE_PLAN.md
  ...
  second_face_plane:
    ...
    plan_document: docs/governance/OPENAI_FACEPLANE_PLAN.md
    public_status: internal_only
  ...
  third_face_plane:
    ...
    plan_document: docs/governance/DOE_T2_CDT_001_FACEPLANE_CONTROL_INPUT_2026-05-31.md
  ...
  fourth_face_plane:
    ...
    plan_document: docs/governance/CONTRACT_RECLAMATION_FACEPLANE_BEFORE_AFTER_REVIEW_2026-05-31.md
    public_status: internal_only
    ...
    alignment_plan: docs/governance/CONTRACT_RECLAMATION_FACEPLANE_ALIGNMENT_PLAN_2026-05-31.md
...
sentinelos_command_surface:
  ...
  outputs:
    ...
    - audit receipt
  attached_documents:
    - docs/governance/SENTINELOS_PROJECT_SITUATION_AND_PUBLICATION_CONTROL_INDEX_2026-05-30.md
...
publication_control_index:
  document: docs/governance/SENTINELOS_PROJECT_SITUATION_AND_PUBLICATION_CONTROL_INDEX_2026-05-30.md
...
daily_cadence_processing:
  ...
  source_state:
    previous_productization_closeout: docs/governance/HOLD_AND_OBSERVE_CLOSEOUT_2026-05-29.md
    current_microsoft_sentinel_template: docs/governance/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_MICROSOFT_SENTINEL_2026-05-29.md
