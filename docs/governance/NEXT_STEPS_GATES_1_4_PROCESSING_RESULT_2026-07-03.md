...
Process the first four exact gates from `docs/GBP/overlays/NEXT_STEPS.md` in order:
...
`docs/governance/AZURE_OWNERFI_PROOF_GREAT_HOLD_STATE_2026-07-03.md`. That record is the
