...
- Sentinel craftsmanship pass added:
  - `docs/governance/SENTINEL_CRAFTSMANSHIP_PASS_2026-05-13.md`
...
- Current Phase 1.1 operating truth remains this approval board plus `docs/governance/EXECUTIVE_SNAPSHOT_2026-05-12.md`.
...
2. Treat `docs/governance/SENTINEL_ARTIFACT_DECISION_REGISTER_2026-05-13.md` as the approved decision surface for the 18 repo organization artifacts.
