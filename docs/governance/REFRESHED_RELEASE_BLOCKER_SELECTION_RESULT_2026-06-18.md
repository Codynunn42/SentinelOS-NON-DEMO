...
| `docs/governance/EXACT_RELEASE_STAGING_MANIFEST_REVIEW_2026-06-15.md` | Prepared a docs-only staging scope from an older worktree state | stale exact staging manifest |
| `docs/governance/EXACT_RELEASE_STAGING_MANIFEST_REVIEW_RESULT_2026-06-15.md` | Accepted older manifest for future exact authorization only | prior review-held result |
...
selection_result:
  ...
  prior_manifest_review_result: docs/governance/EXACT_RELEASE_STAGING_MANIFEST_REVIEW_RESULT_2026-06-15.md
