...
- `docs/governance/WORKFLOW_DEFINITIONS.md` explicitly defers payment automation.
- `docs/governance/PROOF_CASE_PLAN.md` lists billing and payment systems as discovery and integration dependencies.
