...
- Keep it paired with `docs/governance/SENTINELOS_DEMO_PACKAGE_V2.md`.
...
| --- | --- | --- |
| `docs/governance/SENTINELOS_DEMO_PACKAGE_V2.md` | `[APPROVED:DEMO-PACKAGE]` | `npm run check:demo-assets-v2` passed; approval notice issued |
| `docs/governance/SENTINELOS_LIVE_DEMO_SCRIPT_V2.md` | `[APPROVED:DEMO-PACKAGE]` | Script aligned to proof story |
| `docs/governance/SENTINELOS_PROOF_SHEET_V2.md` | `[APPROVED:DEMO-PACKAGE]` | One-page sendable proof sheet |
| `docs/governance/PROOF_CASE_GOVERNED_DEAL_EXECUTION_V2.md` | `[APPROVED:REFERENCE-IMPLEMENTATION]` | Narrow proof case tied to workflow checks |
...
| `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | `[APPROVE:CONDITIONAL]` | Owner confirms canonical operator/auditor reference. |
...
| `docs/governance/SENTINELOS_SOURCE_DOCUMENT_ALIGNMENT_2026-05-06.md` | `[APPROVE:CONDITIONAL]` | Owner confirms V2 whitepaper as current source priority. |
| `docs/governance/BUILD_MANUAL_REVIEW_2026-05-06.md` | `[APPROVE:CONDITIONAL]` | Owner confirms roadmap correction and evidence-gated claims. |
| `docs/governance/FACEPLANE_GAAS_DOCKING_DOCTRINE.md` | `[APPROVE:CONDITIONAL]` | Confirm as current doctrine for OS/face plane/GaaS/docking. |
| `docs/governance/FACEPLANE_SDK_SPEC.md` | `[APPROVE:CONDITIONAL]` | Confirm as initial SDK contract. |
...
| --- | --- | --- |
| `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | `[HOLD:REVIEW]` | Add validation-window template, audit export evidence, and tenant activation approval notice template. |
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | `[HOLD:REVIEW]` | Keep as discussion draft or prepare a governed external-review package. |
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | `[HOLD:REVIEW]` | Confirm source and draft status before circulation. |
