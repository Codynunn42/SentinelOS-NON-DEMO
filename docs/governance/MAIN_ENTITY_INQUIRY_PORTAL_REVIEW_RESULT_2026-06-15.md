...
| `docs/governance/SATURDAY_DAILY_EXECUTIVE_CADENCE_2026-06-13.md` | Routes portal review before resuming entity-specific outcome intake | current cadence support |
