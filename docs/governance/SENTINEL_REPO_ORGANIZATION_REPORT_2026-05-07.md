...
- Sentinel log: `docs/governance/sentinel-repo-organization-log-2026-05-07.jsonl`
...
| logged | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | added | 9 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | added | 10 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/BUILD_MANUAL_REVIEW_2026-05-06.md` | untracked | 2 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/DAILY_BRIEF_RETENTION_RULE.md` | added | 3 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/EXECUTIVE_SNAPSHOT_2026-05-05.md` | untracked | 0 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/FACEPLANE_GAAS_DOCKING_DOCTRINE.md` | untracked | 3 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/FACEPLANE_SDK_SPEC.md` | untracked | 3 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/GOVERNED_TELEMETRY_HARMONIZER.md` | added | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/NUNN_CLOUD_CONTROL_SURFACE_OPERATING_MODEL.md` | added | 2 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | added | 8 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/OWNERFI_PILOT_API_SPEC.md` | added | 0 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/OWNERFI_PILOT_API_SPEC.pdf` | added | 0 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/OWNERFI_TODD_PILOT_MESSAGE.md` | added | 0 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/PAYROLL_EXECUTION_EVIDENCE_PACKET_2026-05-05.md` | added | 0 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/payroll-evidence-index-2026-05-05.json` | added | 0 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/PROOF_CASE_GOVERNED_DEAL_EXECUTION_V2.md` | untracked | 6 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/README.md` | modified | 13 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_APPROVAL_NOTICE_2026-05-04.md` | added | 5 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_APPROVAL_RESUMPTION_2026-05-06.md` | untracked | 0 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_APPROVAL_RISK_ANALYSIS_2026-05-04.md` | added | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_CATEGORY_APPROVAL_NOTICE_2026-05-04.md` | added | 2 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_CATEGORY_COMPLETION_NOTICE_2026-05-04.md` | added | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_DECISION_PATTERN_APPROVAL_NOTICE_2026-05-06.md` | untracked | 1 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_GOVERNANCE_COMPLIANCE_APPROVAL_REPORT_2026-05-04.md` | added | 5 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-04.md` | added | 6 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-07.md` | untracked | 1 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_TARGETED_STREAMLINING_APPROVAL_PLAN_2026-05-04.md` | added | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINELOS_DEMO_PACKAGE_APPROVAL_NOTICE_2026-05-06.md` | untracked | 1 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINELOS_DEMO_PACKAGE_V2.md` | untracked | 5 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINELOS_LIVE_DEMO_SCRIPT_V2.md` | untracked | 6 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINELOS_PROOF_SHEET_V2.md` | untracked | 5 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINELOS_SOURCE_DOCUMENT_ALIGNMENT_2026-05-06.md` | untracked | 3 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/STATE_ANCHORING_RUNBOOK.md` | added | 2 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/STRIPE_CHECKOUT_INGESTION_REPORT.md` | added | 2 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/TASK_TEMPLATES_SYSTEM.md` | added | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | added | 11 | Worktree change logged before any optimization or streamlining decision. |
...
| needs_decision | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | added | 9 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | added | 10 | Generated/presentation asset should be tied to a canonical source document or marked external-deliverable. |
| needs_decision | review | `docs/governance/BUILD_MANUAL_REVIEW_2026-05-06.md` | untracked | 2 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/COMMERCIAL_ASSETS_2026-04-29.pdf` | tracked_clean | 6 | Generated/presentation asset should be tied to a canonical source document or marked external-deliverable. |
| needs_decision | review | `docs/governance/DAILY_BRIEF_2026-04-23.md` | tracked_clean | 6 | Document overlaps another repo artifact by name. Decide whether it is canonical, supporting, or obsolete. |
| needs_decision | review | `docs/governance/DAILY_BRIEF_2026-04-24.md` | tracked_clean | 6 | Document overlaps another repo artifact by name. Decide whether it is canonical, supporting, or obsolete. |
| needs_decision | review | `docs/governance/DAILY_BRIEF_RETENTION_RULE.md` | added | 3 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/EXECUTIVE_SNAPSHOT_2026-05-05.md` | untracked | 0 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/FACEPLANE_GAAS_DOCKING_DOCTRINE.md` | untracked | 3 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/FACEPLANE_SDK_SPEC.md` | untracked | 3 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/GOVERNED_TELEMETRY_HARMONIZER.md` | added | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/NUNN_CLOUD_CONTROL_SURFACE_OPERATING_MODEL.md` | added | 2 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | added | 8 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/OWNERFI_PILOT_API_SPEC.md` | added | 0 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/OWNERFI_PILOT_API_SPEC.pdf` | added | 0 | Generated/presentation asset should be tied to a canonical source document or marked external-deliverable. |
| needs_decision | review | `docs/governance/OWNERFI_TODD_PILOT_MESSAGE.md` | added | 0 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/PAYROLL_EXECUTION_EVIDENCE_PACKET_2026-05-05.md` | added | 0 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/payroll-evidence-index-2026-05-05.json` | added | 0 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/PROOF_CASE_GOVERNED_DEAL_EXECUTION_V2.md` | untracked | 6 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/README.md` | modified | 13 | Document overlaps another repo artifact by name. Decide whether it is canonical, supporting, or obsolete. |
| needs_decision | review | `docs/governance/SENTINEL_APPROVAL_NOTICE_2026-05-04.md` | added | 5 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_APPROVAL_RESUMPTION_2026-05-06.md` | untracked | 0 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_APPROVAL_RISK_ANALYSIS_2026-05-04.md` | added | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_CATEGORY_APPROVAL_NOTICE_2026-05-04.md` | added | 2 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_CATEGORY_COMPLETION_NOTICE_2026-05-04.md` | added | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_DECISION_PATTERN_APPROVAL_NOTICE_2026-05-06.md` | untracked | 1 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_GOVERNANCE_COMPLIANCE_APPROVAL_REPORT_2026-05-04.md` | added | 5 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-04.md` | added | 6 | Document overlaps another repo artifact by name. Decide whether it is canonical, supporting, or obsolete. |
| needs_decision | review | `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-07.md` | untracked | 1 | Document overlaps another repo artifact by name. Decide whether it is canonical, supporting, or obsolete. |
| needs_decision | review | `docs/governance/SENTINEL_TARGETED_STREAMLINING_APPROVAL_PLAN_2026-05-04.md` | added | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINELOS_DEMO_PACKAGE_APPROVAL_NOTICE_2026-05-06.md` | untracked | 1 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINELOS_DEMO_PACKAGE_V2.md` | untracked | 5 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINELOS_LIVE_DEMO_SCRIPT_V2.md` | untracked | 6 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINELOS_PROOF_SHEET_V2.md` | untracked | 5 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINELOS_SOURCE_DOCUMENT_ALIGNMENT_2026-05-06.md` | untracked | 3 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/STATE_ANCHORING_RUNBOOK.md` | added | 2 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/STRIPE_CHECKOUT_INGESTION_REPORT.md` | added | 2 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/TASK_TEMPLATES_SYSTEM.md` | added | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | added | 11 | Changed file needs owner approval before optimize/streamline action. |
...
- Score: 0.85
- Summary: Similar normalized filename or artifact purpose.
- `docs/governance/DAILY_BRIEF_2026-04-23.md`
- `docs/governance/DAILY_BRIEF_2026-04-24.md`
...
- Score: 0.85
- Summary: Similar normalized filename or artifact purpose.
- `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-04.md`
- `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-07.md`
...
- `docs/governance/GO_TO_MARKET.md`
...
- Score: 0.506
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/PAYROLL_EXECUTION_EVIDENCE_PACKET_2026-05-05.md`
- `docs/governance/payroll-evidence-index-2026-05-05.json`
...
- Score: 0.441
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/PROOF_CASE_GOVERNED_DEAL_EXECUTION_V2.md`
- `docs/governance/SENTINELOS_PROOF_SHEET_V2.md`
...
- Score: 0.392
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/PROOF_CASE_OWNERFI.md`
- `docs/governance/WORKFLOW_DEFINITIONS.md`
...
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/README.md`
- `docs/governance/SENTINEL_CATEGORY_APPROVAL_NOTICE_2026-05-04.md`
...
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/README.md`
- `docs/governance/SENTINEL_CATEGORY_COMPLETION_NOTICE_2026-05-04.md`
...
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/README.md`
- `docs/governance/SENTINEL_DECISION_PATTERN_APPROVAL_NOTICE_2026-05-06.md`
...
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/README.md`
- `docs/governance/SENTINEL_GOVERNANCE_COMPLIANCE_APPROVAL_REPORT_2026-05-04.md`
...
- Score: 0.321
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/SENTINELOS_DEMO_PACKAGE_APPROVAL_NOTICE_2026-05-06.md`
- `docs/governance/SENTINELOS_DEMO_PACKAGE_V2.md`
...
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/SENTINELOS_DEMO_PACKAGE_APPROVAL_NOTICE_2026-05-06.md`
- `docs/governance/SENTINEL_APPROVAL_RESUMPTION_2026-05-06.md`
...
- Score: 0.328
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/SENTINEL_APPROVAL_NOTICE_2026-05-04.md`
- `docs/governance/SENTINEL_CATEGORY_APPROVAL_NOTICE_2026-05-04.md`
...
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/SENTINEL_APPROVAL_RESUMPTION_2026-05-06.md`
- `docs/governance/SENTINEL_TARGETED_STREAMLINING_APPROVAL_PLAN_2026-05-04.md`
...
- Score: 0.379
- Summary: Document content overlap above Sentinel review threshold.
- `docs/governance/SENTINEL_APPROVAL_RISK_ANALYSIS_2026-05-04.md`
- `docs/governance/SENTINEL_GOVERNANCE_COMPLIANCE_APPROVAL_REPORT_2026-05-04.md`
