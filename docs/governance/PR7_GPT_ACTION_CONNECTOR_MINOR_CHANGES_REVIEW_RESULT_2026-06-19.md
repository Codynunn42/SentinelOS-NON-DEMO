...
evidence_reviewed:
  ...
  prior_review_packet: docs/governance/PR7_GPT_ACTION_CONNECTOR_REVIEW_PROCESSING_RESULT_2026-06-19.md
  direction_approval: docs/governance/PR7_GPT_ACTION_CONNECTOR_DIRECTION_APPROVAL_RESULT_2026-06-19.md
  local_code_observed:
    - apps/api/server.js
