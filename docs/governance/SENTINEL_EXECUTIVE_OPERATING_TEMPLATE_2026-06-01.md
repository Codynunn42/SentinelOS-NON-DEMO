...
executive_template:
  ...
  recommendation_approval_artifact: docs/governance/SENTINEL_EXECUTIVE_TEMPLATE_RECOMMENDATIONS_APPROVAL_2026-06-01.md
...
source_of_truth:
  ...
  managed_repository_control:
    ...
    - docs/governance/SENTINEL_MANAGED_REPOSITORY_APPROVAL_EXECUTION_RESULT_2026-06-01.md
    - docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-06-01.md
  persistence_manifest:
    - docs/governance/EXACT_STAGING_MANIFEST_REVIEW_CURRENT_CONTROL_PACKET_2026-06-01.md
  quarantine_and_import_reviews:
    - docs/governance/SENTINELOS_OLDER_REPO_AZURE_CLI_QUARANTINE_REVIEW_2026-06-01.md
    ...
    - docs/governance/CONTRACT_RECLAMATION_IMPORT_OR_STANDALONE_DECISION_2026-06-01.md
