...
Evidence: `docs/governance/MICROSOFT_SENTINEL_OUTSTANDING_PRECONDITIONS_CLOSEOUT_2026-05-30.md` and executive template indicate these unknowns.
...
- If you want SentinelOS to run the discovery, provide an execution environment where the operator-approved read-only credentials are accessible (or paste sanitized outputs into `docs/governance/AZURE_ENVIRONMENT_DISCOVERY_RESULT_2026-05-30.md`).
