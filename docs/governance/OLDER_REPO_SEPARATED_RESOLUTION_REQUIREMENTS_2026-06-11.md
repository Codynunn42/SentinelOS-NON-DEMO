...
- `docs/governance/OLDER_REPO_AZURE_CLI_SESSION_QUARANTINE_MANIFEST_2026-06-01.md`;
...
azure_cli_generated_state:
  ...
  existing_manifest: docs/governance/OLDER_REPO_AZURE_CLI_SESSION_QUARANTINE_MANIFEST_2026-06-01.md
```
