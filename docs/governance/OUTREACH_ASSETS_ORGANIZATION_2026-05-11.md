...
|---|---|---|---|---|
| `docs/governance/SENTINELOS_DEMO_PACKAGE_V2.md` | ✅ APPROVED | Partners, prospects | 6-slide deck only | `[APPROVED:DEMO-PACKAGE]` |
| `docs/governance/SENTINELOS_LIVE_DEMO_SCRIPT_V2.md` | ✅ APPROVED | Demo presenters | Live execution guide | `[APPROVED:DEMO-PACKAGE]` |
| `docs/governance/SENTINELOS_PROOF_SHEET_V2.md` | ✅ APPROVED | Quick reference | One-page summary | `[APPROVED:DEMO-PACKAGE]` |
...
| Asset | Status | Audience | Restrictions | Evidence |
|---|---|---|---|---|
| `docs/governance/PROOF_CASE_GOVERNED_DEAL_EXECUTION_V2.md` | ✅ APPROVED | Technical prospects | Reference implementation | `[APPROVED:REFERENCE-IMPLEMENTATION]` |
...
|---|---|---|---|
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | ⏸️ CONTROLLED | `[ROADMAP] [GOVERNMENT-POSITIONING]` | Add disclaimer: "Future capability, not current deployment" |
| `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | ⏸️ CONTROLLED | `[ROADMAP] [EXTERNAL-ASSET]` | Tie to canonical source, mark as positioning brief |
| `docs/governance/GOVERNMENT_POSITIONING.md` | ⏸️ CONTROLLED | `[ROADMAP] [GOVERNMENT-STRATEGY]` | Current phase: enterprise pilots → institutional scaling |

### Commercial & Enterprise

| Asset | Current Status | Required Metadata | Circulation Rules |
|---|---|---|---|
| `docs/governance/COMMERCIAL_ASSETS_2026-04-29.md` | ⏸️ CONTROLLED | `[ROADMAP] [COMMERCIAL-POSITIONING]` | Add disclaimer: "Strategic positioning, not active product" |
| `docs/governance/COMMERCIAL_ASSETS_2026-04-29.pdf` | ⏸️ CONTROLLED | `[ROADMAP] [EXTERNAL-ASSET]` | Tie to canonical source, mark as positioning document |
| `docs/governance/GO_TO_MARKET.md` | ⏸️ CONTROLLED | `[ROADMAP] [GTM-STRATEGY]` | Do not claim government deployment readiness |

### Technical Specifications

| Asset | Current Status | Required Metadata | Circulation Rules |
|---|---|---|---|
| `docs/governance/OWNERFI_PILOT_API_SPEC.pdf` | ⏸️ CONTROLLED | `[PILOT] [API-SPEC]` | Mark as pilot phase, not production API |
| `docs/governance/FACEPLANE_SDK_SPEC.md` | ✅ APPROVED | `[ACTIVE] [TECHNICAL-SPEC]` | Approved face plane contract |
| `docs/governance/SENTINEL_DOCKING_PROTOCOL.md` | ✅ APPROVED | `[ACTIVE] [INTEGRATION-SPEC]` | Approved docking protocol |
...
| `docs/governance/DAILY_BRIEF_2026-04-23.md` | 🔒 INTERNAL | OwnerFi proof path | Immutable proof trail |
| `docs/governance/DAILY_BRIEF_2026-04-24.md` | 🔒 INTERNAL | Proof UI development | Immutable proof trail |
| `docs/governance/DAILY_REPORT_2026-04-21.md` | 🔒 INTERNAL | Early deployment evidence | Immutable proof trail |

### Executive & Decision Records

| Asset | Status | Purpose | Restrictions |
|---|---|---|---|
| `docs/governance/EXECUTIVE_SNAPSHOT_2026-05-05.md` | 🔒 INTERNAL | Control-plane positioning | Decision evidence |
| `docs/governance/EXECUTIVE_SNAPSHOT_2026-05-07.md` | 🔒 INTERNAL | Current verified state | Decision evidence |
| `docs/governance/EXECUTIVE_BOARD_2026-05-11.md` | 🔒 INTERNAL | Latest decision board | Active working board |
| `docs/governance/SENTINEL_APPROVAL_NOTICE_2026-05-04.md` | 🔒 INTERNAL | Approval templates | Internal governance |

### Operational Documentation

| Asset | Status | Purpose | Restrictions |
|---|---|---|---|
| `docs/governance/DEPLOYMENT.md` | 🔒 INTERNAL | Azure deployment guide | Operational reference |
| `docs/governance/BUILD_MANUAL_REVIEW_2026-05-06.md` | 🔒 INTERNAL | Build posture review | Internal alignment |
| `docs/governance/REPO_CONTROL_LAYER.md` | 🔒 INTERNAL | Repository governance | Internal policy |
