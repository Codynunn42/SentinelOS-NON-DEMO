...
| --- | --- | --- |
| Sentinel API deployment | `.github/workflows/deploy.yml`, `Dockerfile`, and `docs/governance/DEPLOYMENT.md` describe an Azure Container Apps deployment path | Implemented deployment contract; current-live state requires refresh |
| Azure Container App | `docs/governance/DEPLOYMENT.md` records `ca-nc-dev-sentinel` and a historical revision | Recorded state; not verified current on 2026-06-12 |
