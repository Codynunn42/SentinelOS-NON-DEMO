...
- one-page ownership handout added at `docs/governance/OWNERSHIP_HANDOUT.md`
...
- Saturday demo script added at `docs/governance/SATURDAY_DEMO_SCRIPT.md`
...
- governance principle documented at `docs/governance/GOVERNANCE_PREFLIGHT.md`
