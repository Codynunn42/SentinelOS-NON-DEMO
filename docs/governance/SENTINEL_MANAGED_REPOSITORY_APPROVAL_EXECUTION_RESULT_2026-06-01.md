...
approved_decisions:
  ...
  active_repo_persistence:
    ...
    manifest: docs/governance/EXACT_STAGING_MANIFEST_REVIEW_CURRENT_CONTROL_PACKET_2026-06-01.md
  ...
  older_repo_quarantine_review:
    ...
    artifact: docs/governance/SENTINELOS_OLDER_REPO_AZURE_CLI_QUARANTINE_REVIEW_2026-06-01.md
    mutation_authorized: false
  contract_reclamation_import_plan:
    phrase: REQUEST_CONTRACT_RECLAMATION_IMPORT_OR_STANDALONE_DECISION
    result: review_artifact_created
    artifact: docs/governance/CONTRACT_RECLAMATION_IMPORT_OR_STANDALONE_DECISION_2026-06-01.md
