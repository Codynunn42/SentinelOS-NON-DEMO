...
| NC-SOS-005 | AI operating setup | AI change hold remains active | `docs/governance/SENTINEL_AI_CHANGE_HOLD_DECLARATION_2026-06-11.md` | hard hold | `REQUEST_EXACT_AI_CHANGE_REVIEW` |
...
tilda_orchestration:
  ...
  Monday_disbursement_packet: docs/governance/MONDAY_INTERNAL_SUPPORT_DISBURSEMENT_PACKET_2026-06-15.md
...
monday_gate_processing:
  TILDA_support_contract:
    result: docs/governance/TILDA_SENTINELOS_SUPPORT_CONTRACT_REVIEW_RESULT_2026-06-15.md
  ...
  release_blocker_selection:
    ...
    manifest: docs/governance/EXACT_RELEASE_STAGING_MANIFEST_REVIEW_2026-06-15.md
  ...
  entity_portal_review:
    result: docs/governance/MAIN_ENTITY_INQUIRY_PORTAL_REVIEW_RESULT_2026-06-15.md
