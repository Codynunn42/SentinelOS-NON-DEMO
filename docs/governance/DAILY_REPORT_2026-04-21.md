...
4. Run the KQL queries in `docs/governance/MICROSOFT_SENTINEL.md` to confirm auth-denied and command-executed events are ingesting.
...
4. Run the KQL queries from `docs/governance/MICROSOFT_SENTINEL.md`.
