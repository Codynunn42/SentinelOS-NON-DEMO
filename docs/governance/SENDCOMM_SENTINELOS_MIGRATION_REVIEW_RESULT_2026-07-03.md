...
ownerfi_ai_financial_management:
  ...
  module_architecture: docs/governance/OWNERFI_AI_FINANCIAL_MANAGEMENT_MODULE_ARCHITECTURE_AND_MANIFEST_RESULT_2026-07-03.md
...
| --- | --- | --- |
| Sentinel API command route | `POST /v1/command` in `docs/governance/SENTINEL_AI_COMMAND_ACCESS_NAMING_AND_VERBIAGE_SCAN_2026-06-17.md` | SendCOMM may map to governed command envelope or communications identity |
| Correct command verbiage | `docs/governance/CORRECTED_SENTINEL_AI_COMMAND_ACCESS_VERBIAGE_REVIEW_RESULT_2026-06-17.md` | SendCOMM must not be represented as a CLI/runtime unless evidenced |
| Execution map | `docs/governance/SENTINEL_RECOMMENDATIONS_GOVERNANCE_PASS_AND_EXECUTION_MAP_2026-07-03.md` | SendCOMM should be classified as platform lineage, communications layer, or historical source before migration |
...
inventory_result: docs/governance/SENDCOMM_GITHUB_SOURCE_INVENTORY_2026-07-06.md
