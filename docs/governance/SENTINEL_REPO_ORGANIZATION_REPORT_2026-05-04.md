...
- Sentinel log: `docs/governance/sentinel-repo-organization-log-2026-05-04.jsonl`
...
| logged | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | untracked | 5 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | untracked | 6 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/DAILY_BRIEF_RETENTION_RULE.md` | untracked | 2 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | untracked | 5 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/README.md` | modified | 9 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_APPROVAL_NOTICE_2026-05-04.md` | untracked | 5 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_APPROVAL_RISK_ANALYSIS_2026-05-04.md` | untracked | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_CATEGORY_APPROVAL_NOTICE_2026-05-04.md` | untracked | 1 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_GOVERNANCE_COMPLIANCE_APPROVAL_REPORT_2026-05-04.md` | untracked | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-04.md` | untracked | 6 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/SENTINEL_TARGETED_STREAMLINING_APPROVAL_PLAN_2026-05-04.md` | untracked | 4 | Worktree change logged before any optimization or streamlining decision. |
| logged | review | `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | untracked | 5 | Worktree change logged before any optimization or streamlining decision. |
...
| Bucket | Decision | File | Status | References | Reason |
| --- | --- | --- | --- | ---: | --- |
| needs_decision | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | untracked | 5 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | untracked | 6 | Generated/presentation asset should be tied to a canonical source document or marked external-deliverable. |
| needs_decision | review | `docs/governance/COMMERCIAL_ASSETS_2026-04-29.pdf` | tracked_clean | 5 | Generated/presentation asset should be tied to a canonical source document or marked external-deliverable. |
...
| needs_decision | review | `docs/governance/DAILY_BRIEF_RETENTION_RULE.md` | untracked | 2 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/NUNN_GOVERNANCE_DOCTRINE_v1.md` | untracked | 5 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/README.md` | modified | 9 | Document overlaps another repo artifact by name. Decide whether it is canonical, supporting, or obsolete. |
| needs_decision | review | `docs/governance/SENTINEL_APPROVAL_NOTICE_2026-05-04.md` | untracked | 5 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_APPROVAL_RISK_ANALYSIS_2026-05-04.md` | untracked | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_CATEGORY_APPROVAL_NOTICE_2026-05-04.md` | untracked | 1 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_GOVERNANCE_COMPLIANCE_APPROVAL_REPORT_2026-05-04.md` | untracked | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_REPO_ORGANIZATION_REPORT_2026-05-04.md` | untracked | 6 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/SENTINEL_TARGETED_STREAMLINING_APPROVAL_PLAN_2026-05-04.md` | untracked | 4 | Changed file needs owner approval before optimize/streamline action. |
| needs_decision | review | `docs/governance/VENDOR_ONBOARDING_RULE_SET_V1.md` | untracked | 5 | Changed file needs owner approval before optimize/streamline action. |
