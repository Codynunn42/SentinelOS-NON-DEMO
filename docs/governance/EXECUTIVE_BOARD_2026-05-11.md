...
| File | Purpose | Action |
|---|---|---|
| `docs/governance/EXECUTIVE_SNAPSHOT_2026-05-07.md` | Current verified state | Reference |
| `docs/governance/SENTINEL_APPROVAL_RESUMPTION_2026-05-06.md` | Approved items list | Reference |
| `docs/governance/EXECUTIVE_TASK_LINEUP_2026-05-07.md` | Work queue | Reference |
| `docs/governance/BUILD_MANUAL_REVIEW_2026-05-06.md` | Roadmap guardrails | Reference |
| `docs/governance/PROOF_CONTROL_PLANE_RELEASE_2026-05-07.md` | Live evidence | Reference |
