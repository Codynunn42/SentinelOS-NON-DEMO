...
weekly_inputs:
  ...
  Monday_daily_cadence: docs/MONDAY_DAILY_EXECUTIVE_CADENCE_2026-06-15.md
  Sunday_weekly_closeout: docs/SUNDAY_WEEKLY_EXECUTIVE_CADENCE_CLOSEOUT_2026-06-14.md
  release_packet: SENTINEL-RELEASE-v1.md
  release_manifest_review_result: docs/EXACT_RELEASE_STAGING_MANIFEST_REVIEW_RESULT_2026-06-15.md
