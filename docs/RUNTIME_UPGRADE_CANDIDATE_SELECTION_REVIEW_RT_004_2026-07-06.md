...
**Document:** `docs/NEXT_RUNTIME_UPGRADE_CANDIDATE_SELECTION_2026-07-06.md`
**Runtime Upgrade Packet:** `docs/RUNTIME_UPGRADE_PACKET_SINTENEX_RT_004_MISSION_CONTROL_CONTROL_PLANE_2026-07-06.md`
**External Use:** held
