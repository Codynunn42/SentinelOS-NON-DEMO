...
```yaml
source_review:
  before_after_review: docs/CONTRACT_RECLAMATION_FACEPLANE_BEFORE_AFTER_REVIEW_2026-05-31.md
  ...
  docking_doctrine: docs/FACEPLANE_GAAS_DOCKING_DOCTRINE.md
  publication_control_index: docs/SENTINELOS_PROJECT_SITUATION_AND_PUBLICATION_CONTROL_INDEX_2026-05-30.md
