...
governing_inputs:
  ...
  Monday_routing: docs/MONDAY_EXECUTIVE_ROUTING_UPDATE_2026-06-15.md
  Monday_support_disbursement: docs/MONDAY_INTERNAL_SUPPORT_DISBURSEMENT_PACKET_2026-06-15.md
```
