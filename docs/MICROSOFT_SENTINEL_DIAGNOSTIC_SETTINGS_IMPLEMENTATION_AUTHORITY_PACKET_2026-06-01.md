...
reconciled_state:
  ...
  diagnostic_settings_lane:
    ...
    later_recorded_execution_result: docs/DIAGNOSTIC_SETTINGS_IMPLEMENTATION_EXECUTION_RESULT_2026-05-31.md
...
operator_decision_options:
  approve_execution_if_not_already_accepted:
    ...
    effect_if_later_given: authorizes_only_the_exact_manifest_in_docs/DIAGNOSTIC_SETTINGS_MUTATION_MANIFEST_2026-06-01.md
  ...
  accept_recorded_2026_05_31_execution_result:
    ...
    effect_if_later_given: treats_docs/DIAGNOSTIC_SETTINGS_IMPLEMENTATION_EXECUTION_RESULT_2026-05-31.md_as_the_governing_record_and_moves_next_gate_to_read_only_KQL_verification
