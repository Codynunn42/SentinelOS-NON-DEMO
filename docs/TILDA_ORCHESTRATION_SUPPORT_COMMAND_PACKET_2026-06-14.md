...
command_packet:
  ...
  settlement_packet: docs/GOVERNANCE_COMPLIANCE_SETTLEMENT_PACKET_2026-06-14.md
  release_packet: SENTINEL-RELEASE-v1.md
  output_matrix: docs/TILDA_SUPPORT_REQUEST_ANSWER_AND_ROUTING_MATRIX_2026-06-14.md
...
routing_rules:
  release_blockers:
    ...
    also_route_to: docs/GOVERNANCE_COMPLIANCE_SETTLEMENT_PACKET_2026-06-14.md
  governance_review:
    destination: docs/EXECUTIVE_BOARD_REFRESHED_FOR_PROCESSING_2026-06-13.md
    also_route_to: docs/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_REFRESHED_FOR_PROCESSING_2026-06-13.md
  external_use_blockers:
    destination: docs/GOVERNANCE_COMPLIANCE_SETTLEMENT_PACKET_2026-06-14.md
    also_route_to: docs/NUNNCORP_SENTINELOS_ISSUE_SUPPORT_TRACKER_2026-06-14.md
  unresolved_infrastructure:
    destination: docs/GOVERNANCE_COMPLIANCE_EVIDENCE_INDEX_2026-06-14.md
    also_route_to: docs/READ_ONLY_CURRENT_SENTINEL_DEPLOYMENT_FOOTPRINT_DISCOVERY_RESULT_2026-06-13.md
  missing_information:
    destination: docs/TILDA_SUPPORT_REQUEST_ANSWER_AND_ROUTING_MATRIX_2026-06-14.md
```
