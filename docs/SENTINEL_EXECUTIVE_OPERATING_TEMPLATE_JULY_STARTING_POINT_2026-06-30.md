...
current_surfaces:
  ...
  sentinel_ai_ready_on_hold_workflow: docs/SENTINEL_AI_JUNE_CLOSEOUT_READY_ON_HOLD_WORKFLOW_2026-06-30.md
  prior_board: docs/EXECUTIVE_BOARD_2026-06-19.md
  prior_executive_template: docs/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_2026-06-19.md
  mob_constant: docs/NUNN_CORPORATION_MASTER_OPERATING_BINDER_2026-06-15.md
  cadence_index: docs/CADENCE_INDEX_2026-06-30.md
  cadence_closeout_plan: docs/CADENCE_CLOSEOUT_PLAN_2026-06-30.md
  current_truth: docs/JUNE_30_CURRENT_TRUTH_REESTABLISHMENT_2026-06-30.md
  weekly_month_end_closeout: docs/WEEKLY_AND_MONTH_END_CLOSEOUT_2026-06-30.md
  july_priority_queue: docs/JULY_PRIORITY_QUEUE_DEEP_DIVE_DECISION_PACKETS_2026-06-30.md
  queue_approval: docs/JULY_QUEUE_ORDER_AND_FIRST_ACTION_APPROVAL_RESULT_2026-06-30.md
  live_proof_result: docs/LIVE_PROOF_HEALTH_VERIFICATION_RESULT_2026-06-30.md
  live_proof_retry: docs/LIVE_PROOF_HEALTH_RETRY_RESULT_2026-06-30.md
  tomorrow_start: docs/JUNE_30_DAILY_CLOSEOUT_AND_TOMORROW_START_2026-06-30.md
```
