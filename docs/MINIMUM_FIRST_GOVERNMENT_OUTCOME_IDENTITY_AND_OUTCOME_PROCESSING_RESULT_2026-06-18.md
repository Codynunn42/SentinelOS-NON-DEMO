...
| --- | --- | --- |
| `docs/AUTHORITATIVE_GOVERNMENT_OUTCOME_INTAKE_WORKSHEET_2026-06-12.md` | Defines the authorized owner-provided intake scope and required fields | intake control worksheet |
| `docs/FIRST_GOVERNMENT_OUTCOME_INTAKE_INPUT_PROCESSING_RESULT_2026-06-12.md` | Confirms no entity-specific intake inputs were supplied | zero-fabrication intake result |
| `docs/GOVERNMENT_OUTCOME_OPERATING_SYSTEM_REVIEW_PACKET_2026-06-12.md` | Keeps entity-specific facts open and requires authoritative intake before modeling | government outcome review packet |
| `docs/EXECUTIVE_DRIFT_FOCUS_REPORT_2026-06-18.md` | Records all State/government required facts as `unsupported_open` | drift focus report |
