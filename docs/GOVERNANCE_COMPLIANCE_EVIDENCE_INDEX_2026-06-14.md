...
| --- | --- | --- |
| Executive Board | `docs/EXECUTIVE_BOARD_REFRESHED_FOR_PROCESSING_2026-06-13.md` | current Board processing surface |
| Executive Template | `docs/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_REFRESHED_FOR_PROCESSING_2026-06-13.md` | current executive operating surface |
| Executive Snapshot | `docs/EXECUTIVE_SNAPSHOT_2026-06-13.md` | current state reference |
| Daily cadence | `docs/SATURDAY_DAILY_EXECUTIVE_CADENCE_2026-06-13.md` | most recent daily cadence |
| Friday closeout | `docs/FRIDAY_DAILY_EXECUTIVE_CADENCE_CLOSEOUT_2026-06-12.md` | accepted review-held daily closeout |
| Weekly closeout | `docs/FRIDAY_WEEKLY_EXECUTIVE_CADENCE_CLOSEOUT_2026-06-12.md` | accepted review-held weekly closeout |
| AI change hold | `docs/SENTINEL_AI_CHANGE_HOLD_DECLARATION_2026-06-11.md` | active controlling hold |
| Record classification | `docs/SENTINEL_AI_RECORD_CLASSIFICATION_AND_ACCESS_SEGREGATION_POLICY_2026-06-12.md` | policy recorded; implementation held |
| Record reconciliation | `docs/RECORD_CLASSIFICATION_DIRECTIVE_RECONCILIATION_2026-06-12.md` | active investigation narrowed to Infrastructure Records |
| Deployment footprint | `docs/READ_ONLY_CURRENT_SENTINEL_DEPLOYMENT_FOOTPRINT_DISCOVERY_RESULT_2026-06-13.md` | bounded Azure metadata evidence |
...
| PostgreSQL memory | `docs/POSTGRESQL_MEMORY_LAYER_LIVE_VERIFICATION_RECONCILIATION_2026-06-12.md` | bounded runtime database verification; end-to-end Memory Layer unverified |
...
| Government intake | `docs/FIRST_GOVERNMENT_OUTCOME_INTAKE_INPUT_PROCESSING_RESULT_2026-06-12.md` | zero-fabrication intake; owner inputs missing |
| Entity portal | `docs/SENTINELOS_ENTITY_INQUIRY_PORTAL_RECONCILIATION_2026-06-12.md` | local surface evidence; external activation held |
| Sovereign governance | `docs/SOVEREIGN_SECURITY_AND_GOVERNANCE_OVERVIEW_DRAFT_2026-06-11.md` | draft support evidence; external claims held |
