...
```yaml
processed_from:
  executive_packet: docs/JULY_03_EXECUTIVE_TEMPLATE_PACKET_PROCESSING_RESULT_2026-07-03.md
  active_template: docs/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_2026-07-03.md
