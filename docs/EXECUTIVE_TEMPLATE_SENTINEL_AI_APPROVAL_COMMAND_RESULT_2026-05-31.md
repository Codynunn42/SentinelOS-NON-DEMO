...
```yaml
source_artifacts:
  executive_template: docs/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_CURRENT_2026-05-31.md
  executive_snapshot: docs/EXECUTIVE_SNAPSHOT_CURRENT_2026-05-31.md
  diagnostic_settings_result: docs/DIAGNOSTIC_SETTINGS_IMPLEMENTATION_EXECUTION_RESULT_2026-05-31.md
...
successful_command:
  ...
  task:
    ...
    badge: "[APPROVE]"
    source: docs/SENTINEL_EXECUTIVE_OPERATING_TEMPLATE_CURRENT_2026-05-31.md
  approval:
...
current_result:
  ...
  process_result: docs/EXECUTIVE_TEMPLATE_APPROVAL_PROCESS_RESULT_2026-05-31.md
