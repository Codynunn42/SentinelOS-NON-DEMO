...
**Release Packet Pattern:** `docs/RUNTIME_UPGRADE_CANDIDATE_RELEASE_PACKET_WHITE_GLOVE_2026-07-06.md`
**External Use:** held
...
| --- | --- | --- |
| `SINTENEX-RT-003` | `docs/RUNTIME_UPGRADE_PACKET_SINTENEX_RT_003_RECEIPT_AUDIT_DECISION_SURFACE_2026-07-06.md` | approved_for_introduction |
| `SINTENEX-RT-001` | `docs/RUNTIME_UPGRADE_PACKET_SINTENEX_RT_001_OWNERFI_ROUTE_HEALTH_2026-07-06.md` | approved_for_introduction |
| `SINTENEX-RT-005` | `docs/RUNTIME_UPGRADE_PACKET_SINTENEX_RT_005_GOVERNANCE_PRIMITIVES_2026-07-06.md` | approved_for_introduction |
...
```yaml
verification_run:
  refreshed_by: docs/SINTENEX_RUNTIME_UPGRADE_READINESS_CONTROL_RESULT_2026-07-06.md
  receipt_lookup:
