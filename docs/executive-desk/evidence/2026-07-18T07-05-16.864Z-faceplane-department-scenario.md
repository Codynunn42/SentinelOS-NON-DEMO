...
Generated: 2026-07-18T07:05:16.864Z
...
- Average mission latency (ms): 0.346
- P95 mission latency (ms): 1.775

## Department Load

- Virtual operators: 100
- Total commands: 600
- Throughput (commands/sec): 91379.84
- P50 mission latency (ms): 0.052
- P95 mission latency (ms): 0.078
- P99 mission latency (ms): 0.265
- P95 docking latency (ms): 0.041

## Repeatability

- Repetitions: 2
- Scenario P95 mission latency variance (ms): min=0.099, avg=0.165, max=0.23
- Load P95 mission latency variance (ms): min=0.155, avg=0.192, max=0.228
- Throughput variance (commands/sec): min=67727.73, avg=75757.455, max=83787.18
