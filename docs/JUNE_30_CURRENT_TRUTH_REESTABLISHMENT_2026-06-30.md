...
| --- | --- | --- |
| Cadence restart | `docs/CADENCE_CLOSEOUT_PLAN_2026-06-30.md` defines the restart sequence and deep dive decision packet standard | verified_local |
| Next-step queue | `docs/NEXT_STEPS.md` lists Hardening Focus, Engineering Next, and Platform Next | verified_local |
| Latest board cadence | `docs/EXECUTIVE_BOARD_2026-06-19.md` and `docs/FRIDAY_WEEKLY_EXECUTIVE_CADENCE_2026-06-19.md` remain the latest completed board/weekly cadence surfaces found in local docs | verified_local |
| Latest state model | `docs/SENTINELOS_STATE_STEWARDSHIP_MODEL_2026-06-20.md` is the latest operational-state model found in local docs | verified_local |
| Live OwnerFi proof claim | `docs/NEXT_STEPS.md` records `https://ca-nc-dev-sentinel.calmhill-388e1d39.eastus2.azurecontainerapps.io/proof` as the shareable proof surface, last verified on 2026-04-28 | recorded_state_needs_reverification |
...
| --- | --- | --- |
| Receipt/audit lookup | `apps/api/server.js` exposes `GET /v1/receipts/:receiptId`; `scripts/check-receipt-lookup.js` passed today; `docs/EXECUTIVE_SNAPSHOT_2026-05-12.md` also recorded it as passed | candidate substantial feature for a clean operator decision surface after live proof verification |
...
next_daily_action:
  ...
  current_gate_result:
    artifact: docs/LIVE_PROOF_HEALTH_VERIFICATION_RESULT_2026-06-30.md
