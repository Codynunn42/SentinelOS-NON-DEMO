...
| SINTINEX TILDA docking | `docs/SINTINEX_TILDA_DOCKING_2026-05-13.md` | `[APPROVED:DOCKED-OBSERVE-ROUTE-ONLY]` | future-facing ideas, productive drift, archive references, deferred material routed by TILDA | `npm run check:sintinex` | Internal intelligence/lineage reference |
