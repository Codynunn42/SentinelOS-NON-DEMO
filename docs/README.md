...
| SINTENIX TILDA docking | `docs/SINTINEX_TILDA_DOCKING_2026-05-13.md`, `docs/SINTENIX_INGESTION_LEDGER_2026-05-13.md` | `[APPROVED:INGESTION-STARTED]` | archival cognition, lineage interpretation, historical synthesis, future-facing ideas, archive references, deferred material routed by TILDA | `npm run check:sintinex` | Internal intelligence/lineage reference |
