...
| Commercial collateral | `docs/COMMERCIAL_ASSETS_2026-04-29.md` | `[APPROVE:CONDITIONAL]` | governed execution messaging tied to current proof claims | source for `docs/COMMERCIAL_ASSETS_2026-04-29.pdf` | External-ready after source/PDF pairing approval |
| Commercial collateral PDF | `docs/COMMERCIAL_ASSETS_2026-04-29.pdf` | `[APPROVE:CONDITIONAL]` | generated deliverable from commercial source Markdown | paired to `docs/COMMERCIAL_ASSETS_2026-04-29.md` | External-ready after final owner confirmation |
...
| Arizona SPO brief source | `docs/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | `[HOLD:REVIEW]` | public-sector vendor onboarding modernization proposal | source for `docs/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | Draft only, not approved for external publication |
| Arizona SPO brief PDF | `docs/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | `[HOLD:REVIEW]` | generated public-sector discussion draft | paired to `docs/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | Draft only, not approved for external publication |
...
| Daily brief 2026-04-23 | `docs/DAILY_BRIEF_2026-04-23.md` | `[HOLD:REVIEW]` | historical operating snapshot | protected by daily brief retention rule | Internal historical record |
| Daily brief 2026-04-24 | `docs/DAILY_BRIEF_2026-04-24.md` | `[HOLD:REVIEW]` | historical operating snapshot | protected by daily brief retention rule | Internal historical record |
...
No broad cleanup, deletion, archival, merge consolidation, runtime refactor, external publication of held documents, or canonical promotion of held documents is approved from this index.
...
| --- | --- | --- | --- |
| `docs/COMMERCIAL_ASSETS_2026-04-29.pdf` | `docs/COMMERCIAL_ASSETS_2026-04-29.md` | `[APPROVE:CONDITIONAL]` | Owner confirmation that PDF matches approved source. |
| `docs/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.pdf` | `docs/ARIZONA_SPO_MODERNIZATION_BRIEF_LAYOUT.md` | `[HOLD:REVIEW]` | Keep draft-only until source is approved and PDF is regenerated or labeled draft. |
