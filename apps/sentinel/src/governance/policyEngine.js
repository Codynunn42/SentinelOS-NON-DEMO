...
const commandScopes = {
  ...
  'support.ticket.create': 'support:write',
  'support.refund.request': 'support:refund',
  'ticket.create': 'support:write',
  'refund.request': 'support:refund',
  ...
  'drift.recommendation.instruct': 'platform:admin',
  'drift.issues.classify': 'platform:admin',
  'approval.bottleneck.analyze': 'platform:admin'
};
